...
- Add `[USE_PR_TITLE]` to the **PR title** and/or **Summary** → workflow saves the **subject**, then **removes the flag** from the PR.
- Add `[USE_PR_DESC]` on a line in **Summary only** → workflow saves **this section** as the commit body, then **removes the flag**.
